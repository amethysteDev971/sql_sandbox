<?php
    ...
    class Liste {
         ...
         *
         * @param array $taches - Un tableau associatif de tâches, où chaque clé est un identifiant et chaque valeur est un titre.
         */
         ...
         *
         * @return \Tache|null - Retourne l'objet Tache si trouvé, sinon null
         */
