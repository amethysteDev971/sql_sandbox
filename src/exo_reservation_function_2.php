<?php
    ...
    createRoom($rooms, '1', 'Salle 1', 10, 10, 20);
    createRoom($rooms, '2', 'Salle 2', 14, 23, 100);
    createRoom($rooms, '3', 'Salle 3', 18, 58, 78);
    ...
    createReservation($reservations, $rooms,'1', 'Jean', '1', new DateTime('2021-01-01 08:00'));
    createReservation($reservations, $rooms, '2', 'Paul', '2');
    createReservation($reservations, $rooms, '3', 'Pierre', '3');
    createReservation($reservations, $rooms, '4', 'Paul', '1');
